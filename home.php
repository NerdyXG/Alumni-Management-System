   ...
   min-height: calc(100%)
        ...
        <header class="masthead">
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                        ...
                        <p class="text-light mt-4">This is an Integrated System for the Alumni members of the University of Ibadan since 1948, this was borne out of the need to create a synergy between various alumni and current students for the greater good.</p>
            ...
            <div class="container mt-3 pt-2">
                ...
                <p class="text-light mt-4 text-center">No upcoming events for now, check back later!</p>
                <hr class="divider my-4">
                <?php
